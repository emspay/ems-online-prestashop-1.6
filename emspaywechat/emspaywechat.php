...
class emspayWechat extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('EMS Online WeChat');
        $this->description = $this->l('Accept payments for your products using WeChat.');
