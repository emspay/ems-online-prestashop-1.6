...
class emspayTikkiePaymentRequest extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('EMS Online Tikkie Payment Request');
        $this->description = $this->l('Accept payments for your products using Tikkie Payment Request.');
    ...
    public function hookDisplayPaymentEU($params)
    {
        ...
        return array(
            'cta_text' => $this->l('Pay by Tikkie Payment Request'),
