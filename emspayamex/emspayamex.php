...
class emspayAmex extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('EMS Online American Express');
        $this->description = $this->l('Accept payments for your products using American Express.');
    ...
    public function hookDisplayPaymentEU($params)
    {
        ...
        return array(
            'cta_text' => $this->l('Pay by American Express'),
    ...
    public function execPayment($cart, $locale = '')
    {
        ...
        if ($response['status'] == 'error') {
            return $response['transactions'][0]['reason'];
        }
