...
class ingpspCreditcard extends PaymentModule
{
    private $_html = '';
    ...
    public function hookDisplayPaymentEU($params)
    {
        ...
        return array(
            'cta_text' => $this->l('Pay by Mastercard, VISA, Maestro or V PAY'),
            'logo' => Media::getMediaPath(dirname(__FILE__).'/ingpspcreditcard.png'),
