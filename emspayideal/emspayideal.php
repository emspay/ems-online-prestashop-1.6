...
class emspayIdeal extends PaymentModule
{
    private $_html = '';
    ...
    public function hookPayment($params)
    {
        ...
        try {
            $issuers = $this->ginger->getIdealIssuers()->toArray();
        } catch (\Exception $e) {
    ...
    public function hookDisplayPaymentEU($params)
    {
        ...
        return array(
            'cta_text' => $this->l('Pay by iDEAL'),
            'logo' => Media::getMediaPath(dirname(__FILE__).'/emspayideal.png'),
